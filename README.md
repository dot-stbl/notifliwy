...
public record NeedNotification;
...
|--------------------------------------|---------|----------------------------------------------------|
| Notifliwy.Provider.MassTransit.Kafka | 3.1.0   | Notifliwy Consumers provider for MassTransit/Kafka |
...
| Notifliwy.OpenTelemetry.Instrumentation | 3.0.0   | **OpenTelemetry** instruments extensions for `Notifliwy`     |
